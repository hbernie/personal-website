  ...
  return(
    ...
    <div className='w-2/3'>
      <div className='flex flex-row'>
        ...
        <a href='https://www.npmjs.com/package/latchql' target='_blank'><img src={latchql} className='w-1/2 h-1/2 hover:scale-125 transition-all duration-500 rounded-md'></img></a>
      </div>

        <br></br>

        <div className='flex flex-row mt-3'>
        <a href='https://github.com/AlpsCo/WhatInTheWorld' target='_blank'><img src={trivia} className='w-1/2 h-1/2 hover:scale-125 transition-all duration-500 rounded-md'></img></a>
      ...
      <div className='flex flex-row mt-3'>
        ...
        <a href='https://github.com/MeetmeattheSpot/Meet-me-at-the-Spot/tree/dev' target='_blank'><img src={spot} className='w-1/2 h-1/2 hover:scale-125 transition-all duration-500 rounded-md'></img></a>
      </div>
