  ...
  return(
    <><nav className="flex items-center justify-between flex-wrap bg-indigo-400 p-4">
      ...
      <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
        ...
        <div>
          <a href="#" className="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-indigo-900 hover:bg-white mt-4 lg:mt-0">Download Resume</a>
        </div>
      </div>
    </nav></>
  )
